...
<!-- badges: start -->
[![CRAN version](https://www.r-pkg.org/badges/version/fca)](https://CRAN.R-project.org/package=fca)
[![CRAN checks](https://cranchecks.info/badges/worst/fca)](https://cran.r-project.org/web/checks/check_results_fca.html)
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/last-month/fca?color=brightgreen)](https://CRAN.R-project.org/package=fca)
...
You can install the released version of fca from [CRAN](https://CRAN.R-project.org/package=fca) with:
